...
def load_checkpoint(args, trainer):
    ...
    extra_state, state = trainer.load_checkpoint(
        checkpoint_path,
    ...
    return extra_state, epoch_itr, state
...
def load_model_ensemble(filenames, arg_overrides=None, task=None):
    ...
    """
    ensemble, args, _task, state = load_model_ensemble_and_task(filenames, arg_overrides, task)
    return ensemble, args, state
...
def load_model_ensemble_and_task(filenames, arg_overrides=None, task=None):
    ...
    return ensemble, args, task, state
...
def save_state(
    ...
    num_updates, optim_history=None, extra_state=None, prune_mask=None
):
