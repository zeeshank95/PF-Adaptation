...
class _PF_AdaptIndexedRawTextDataset:
...
class PF_AdaptIndexedRawTextDataset(IndexedRawTextDataset):
    ...
    def _maybe_read(self, corpus, tokenizer):
        ...
        if path not in _flyweight:
            ...
            if not LMDBCorpus.exists(corpus):
                ...
                raw_dataset = _PF_AdaptIndexedRawTextDataset(corpus, tokenizer)
